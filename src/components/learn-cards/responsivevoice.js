...
if ("undefined" != typeof responsiveVoice) console.log("ResponsiveVoice already loaded"), console.log(responsiveVoice); else var ResponsiveVoice = function () {
    ...
    a.init = function () {
        ...
        (a.iOS || a.is_android) && a.enableWindowClickHook();
        a.Dispatch("OnLoad")
    };
    ...
    a.speak = function (b, c, d) {
        if (a.rvsMapped) {
            ...
            if (a.is_android && (a.fallbackMode || a.forcedFallbackMode) && !a.android_initialized) a.initFallbackPool(), a.scheduledSpeak = {
                text: b,
                voicename: c,
                parameters: d
            }; else if (a.iOS && (a.fallbackMode || a.forcedFallbackMode) && !a.iOS_initialized) a.initFallbackPool(), a.scheduledSpeak =
                {text: b, voicename: c, parameters: d}; else {
                a.fallbackMode && 0 < a.fallback_audiopool.length && a.clearFallbackPool();
                a.msgprofile = f;
                a.log("Voice picked: " + a.msgprofile.systemvoice.name);
                a.utterances = [];
                for (g = 0; g < k.length; g++) if (!a.fallbackMode && a.getServiceEnabled(a.services.NATIVE_TTS)) a.log("Using SpeechSynthesis"), h = a.services.NATIVE_TTS, e = new SpeechSynthesisUtterance, e.voiceURI = f.systemvoice.voiceURI, e.volume = a.selectBest([f.collectionvoice.volume, f.systemvoice.volume, 1]), e.rate = a.selectBest([a.iOS9plus ?
                ...
                e.hasOwnProperty("addEventListener") && e.addEventListener("end", a.speech_onend)), e.onerror = d.onerror || function (b) {
                    ...
                    e.onboundary = a.onboundary, e.onerror = function (b) {
                    a.log("RV: Unknow Error");
                    a.log(b)
                    ...
                    var m = a.selectBest([f.collectionvoice.volume, f.systemvoice.volume,
                        1]);
                    if (null != d) {
                    ...
                    e = a.fallbackServicePath + "?t=" + encodeURIComponent(k[g]) + "&tl=" + (f.collectionvoice.lang || f.systemvoice.lang || "en-US") + "&sv=" + (f.collectionvoice.service || f.systemvoice.service || "") + "&vn=" + (f.collectionvoice.voicename || f.systemvoice.voicename || "") + "&pitch=" + e.toString() + "&rate=" + l.toString() +
                        "&vol=" + m.toString();
                    n && (e += "&extraParams=" + JSON.stringify(n));
                    l = a.fallback_audioPool_getAudio();
                    null != l && (l.src = e, l.playbackRate = a.fallback_playbackrate, l.preload = "auto", l.load(), a.fallback_parts.push(l))
                }
    ...
    a.fallback_startPart = function () {
        ...
        null ==
        a.fallback_audio ? a.log("RV: Fallback Audio is not available") : (function () {
            ...
            a.fallback_finishPart), a.useTimer && a.startTimeout(a.multipartText[a.fallback_part_index], a.fallback_finishPart))
    };
    ...
    a.getSystemVoice = function (b) {
        ...
        for (var h = 0; h < a.systemvoices.length; h++) if (0 === a.systemvoices[h].name.localeCompare(b) || 0 === a.systemvoices[h].name.replace(new RegExp("\\s+|" + c, "g"), "").replace(/ *\([^)]*\) */g,
                "").localeCompare(d)) return a.systemvoices[h];
        return null
    };
    a.getResponsiveVoice = function (b) {
        for (var c = 0; c < a.responsivevoices.length; c++) if (a.responsivevoices[c].name == b) return b = a.fallbackMode, !0 === a.responsivevoices[c].mappedProfile.collectionvoice.fallbackvoice || !0 === a.forcedFallbackMode ? (a.fallbackMode = !0, a.fallback_parts = []) : a.fallbackMode = !1, b != a.fallbackMode && (a.mapRVs(), a.Dispatch("OnServiceSwitched")), a.responsivevoices[c];
        return null
    };
    ...
    a.clickEvent = function () {
        ...
        a.is_android && !a.android_initialized && (a.click_event_detected = !0, a.initFallbackPool());
    ...
    a.initFallbackPool = function () {
        if ((a.is_android || a.iOS) && !a.click_event_detected) a.allowSpeechDiv || (a.allowSpeechDiv_appearances = null == a.allowSpeechDiv_appearances ? 1 : ++a.allowSpeechDiv_appearances, 2 < a.allowSpeechDiv_appearances ? console.log("ResponsiveVoice: Speech not allowed by user") : (a.allowSpeechDiv =
            document.createElement("div"), document.body.appendChild(a.allowSpeechDiv), a.allowSpeechDiv.style.cssText = "left: 0px; bottom: 0px; width: 100vw; height:auto; background-color: #fee891; position: fixed;", a.allowSpeechDiv.innerHTML = '<p style="text-align:center">This page wants to use speech.  <button onclick="responsiveVoice.allowSpeechClicked(true);">Allow</button>&nbsp;<button onclick="responsiveVoice.allowSpeechClicked(false);">Deny</button></p>')); else if (!a.fallback_audiopool || 0 == a.fallback_audiopool.length) {
            for (var b =
                0; 10 > b; b++) {
                var c = b, d = document.createElement("AUDIO");
                d.preload = "auto";
                a.is_android && (d.src = "", d.load(), 9 == c && (a.log("Android audio initialized"), a.android_initialized = !0));
                a.iOS && (d.src = "", d.load(), 9 == c && (a.log("iOS audio initialized"), a.iOS_initialized = !0));
    ...
    a.allowSpeechClicked = function (b) {
        ...
        b && (a.clickEvent(), a.scheduledSpeak && (a.speak(a.scheduledSpeak.text,
            a.scheduledSpeak.voicename, a.scheduledSpeak.parameters), a.scheduledSpeak = null))
    };
    a.fallback_audioPool_getAudio = function () {
        a.initFallbackPool();
        a.fallback_audiopool_index >= a.fallback_audiopool.length && (a.log("Audio pool capacity over. Reusing from index 0"), a.fallback_audiopool_index = 0);
    ...
    a.selectBest = function (a) {
        for (var b = 0; b < a.length; b++) if (null !=
            a[b]) return a[b];
        return null
    };
    a.pause = function () {
    ...
    a.setVolume = function (b) {
        if (a.isPlaying()) if (a.fallbackMode) {
            ...
            for (c = 0; c < a.fallback_audiopool.length; c++) a.fallback_audiopool[c].volume =
                b;
